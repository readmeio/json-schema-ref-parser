...
import { ParserError, ResolverError } from '../../../lib/util/errors';
import path from '../../utils/path';

describe('Invalid syntax', function () {
  describe('in main file', function () {
    it('should throw an error for an invalid file path', async function () {
      try {
    ...
    it('should throw an error for an invalid YAML file', async function () {
      try {
    ...
    it('should throw an error for an invalid JSON file', async function () {
      try {
    ...
    it('should throw an error for an invalid JSON file with YAML disabled', async function () {
      try {
    ...
    it('should throw an error for an invalid YAML file with JSON and YAML disabled', async function () {
      try {
    ...
    describe('when continueOnError is true', function () {
      it('should throw a grouped error for an invalid file path', async function () {
      ...
      it('should throw a grouped error for an invalid YAML file', async function () {
        const parser = new $RefParser();
        try {
      ...
      it('should throw a grouped error for an invalid JSON file', async function () {
        const parser = new $RefParser();
        try {
      ...
      it('should throw a grouped error for an invalid JSON file with YAML disabled', async function () {
        const parser = new $RefParser();
        try {
          await parser.dereference(path.rel('specs/invalid/invalid.json'), {
      ...
      it('should not throw an error for an invalid YAML file with JSON and YAML disabled', async function () {
        const parser = new $RefParser();
        const result = await parser.dereference(path.rel('specs/invalid/invalid.yaml'), {
          continueOnError: true,
  ...
  describe('in referenced files', function () {
    ...
    it('should throw a grouped error for an invalid YAML file with JSON and YAML disabled', async function () {
