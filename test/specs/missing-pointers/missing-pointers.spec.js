...
describe('Schema with missing pointers', function () {
  it('should throw an error for missing pointer', async function () {
    try {
  ...
  it('should throw an error for missing pointer in external file', async function () {
    try {
  ...
  context('when continueOnError is true', function () {
    it('should throw a grouped error for missing pointer', async function () {
