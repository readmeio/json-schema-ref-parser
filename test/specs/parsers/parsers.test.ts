...
import { UnmatchedParserError } from '../../../lib/util/errors';
...
describe('References to non-JSON files', () => {
  ...
  /** @fixme the buffer work in this is pretty flaky */
  // eslint-disable-next-line vitest/no-disabled-tests
  it.skip('should parse text as binary if "parse.text" is disabled', async () => {
