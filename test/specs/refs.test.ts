...
import bundledSchema from './external/bundled';
import dereferencedSchema from './external/dereferenced';
import parsedSchema from './external/parsed';
